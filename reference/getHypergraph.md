...
#> Read binary files (0.000191803 sec.)
#> Build the HMDP (3.2037e-05 sec.)
...
#>  Finished. Cpu time 9.895e-06 sec.
...
#> Read binary files (0.000179676 sec.)
#> Build the HMDP (2.707e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.262e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000232304 sec.)
#> Build the HMDP (0.000140687 sec.)
#> Checking MDP and found no errors (3.025e-06 sec.)
