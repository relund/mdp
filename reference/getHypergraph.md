...
and a tibble `hyperarcs`. `hyperarcs` stores `actionWeights`, `trans`,
and `pr` as list-columns of vectors. `transWeights` is a list-column of
...
#> Read binary files (0.000214739 sec.)
#> Build the HMDP (4.1512e-05 sec.)
#> Checking MDP and found no errors (3.946e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 1.0165e-05 sec.
...
#> Read binary files (0.000165005 sec.)
#> Build the HMDP (2.8302e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.312e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000247197 sec.)
#> Build the HMDP (0.000192516 sec.)
#> Checking MDP and found no errors (2.794e-06 sec.)
