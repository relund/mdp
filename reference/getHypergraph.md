...
#> Read binary files (0.000152222 sec.)
#> Build the HMDP (2.8132e-05 sec.)
#> Checking MDP and found no errors (1.102e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 6.161e-06 sec.
...
#> Read binary files (0.000130823 sec.)
#> Build the HMDP (2.147e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.533e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000190003 sec.)
#> Build the HMDP (0.000149597 sec.)
#> Checking MDP and found no errors (2.034e-06 sec.)
