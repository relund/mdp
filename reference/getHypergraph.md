...
#> Read binary files (0.000185298 sec.)
#> Build the HMDP (3.4662e-05 sec.)
#> Checking MDP and found no errors (3.716e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 9.414e-06 sec.
...
#> Read binary files (0.000162574 sec.)
#> Build the HMDP (2.7131e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.302e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000221983 sec.)
#> Build the HMDP (0.000166861 sec.)
#> Checking MDP and found no errors (2.894e-06 sec.)
