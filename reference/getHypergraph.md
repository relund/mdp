...
#> Read binary files (0.000192319 sec.)
#> Build the HMDP (3.221e-05 sec.)
...
#>  Finished. Cpu time 9.968e-06 sec.
...
#> Read binary files (0.000151854 sec.)
#> Build the HMDP (2.7221e-05 sec.)
#> Checking MDP and found no errors (2.274e-06 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 2.274e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000244917 sec.)
#> Build the HMDP (0.000143318 sec.)
#> Checking MDP and found no errors (4.518e-06 sec.)
