...
#> Read binary files (0.000159208 sec.)
#> Build the HMDP (2.9145e-05 sec.)
#> Checking MDP and found no errors (9.71e-07 sec.)
plot(mdp)
...
#>  Finished. Cpu time 7.323e-06 sec.
...
#> Read binary files (0.000136254 sec.)
#> Build the HMDP (2.2291e-05 sec.)
#> Checking MDP and found no errors (9.52e-07 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 9.52e-07 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000200875 sec.)
#> Build the HMDP (0.000136735 sec.)
#> Checking MDP and found no errors (2.415e-06 sec.)
