...
#> Read binary files (0.000153835 sec.)
#> Build the HMDP (3.2401e-05 sec.)
#> Checking MDP and found no errors (2.986e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 7.644e-06 sec.
...
#> Read binary files (0.00015638 sec.)
#> Build the HMDP (2.5267e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.042e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000204359 sec.)
#> Build the HMDP (0.000173602 sec.)
#> Checking MDP and found no errors (1.934e-06 sec.)
