...
#> Read binary files (0.000163061 sec.)
#> Build the HMDP (2.697e-05 sec.)
#> Checking MDP and found no errors (8.61e-07 sec.)
plot(mdp)
...
#>  Finished. Cpu time 8.242e-06 sec.
...
#> Read binary files (0.000152155 sec.)
#> Build the HMDP (2.1683e-05 sec.)
#> Checking MDP and found no errors (9.21e-07 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 9.21e-07 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.00018954 sec.)
#> Build the HMDP (0.000107549 sec.)
#> Checking MDP and found no errors (1.723e-06 sec.)
