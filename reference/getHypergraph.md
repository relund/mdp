...
#> Read binary files (0.000152824 sec.)
#> Build the HMDP (3.2321e-05 sec.)
#> Checking MDP and found no errors (3.506e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 6.141e-06 sec.
...
#> Read binary files (0.000150159 sec.)
#> Build the HMDP (2.7862e-05 sec.)
#> Checking MDP and found no errors (1.353e-06 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.353e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000227233 sec.)
#> Build the HMDP (0.000179023 sec.)
#> Checking MDP and found no errors (2.074e-06 sec.)
