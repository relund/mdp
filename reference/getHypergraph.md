...
#> Read binary files (0.000209014 sec.)
#> Build the HMDP (3.357e-05 sec.)
#> Checking MDP and found no errors (1.061e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 9.144e-06 sec.
...
#> Read binary files (0.000158558 sec.)
#> Build the HMDP (2.5118e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.332e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000215684 sec.)
#> Build the HMDP (0.000155233 sec.)
