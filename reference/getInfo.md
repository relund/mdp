...
mdp<-loadMDP(prefix)
#> Read binary files (0.00016144 sec.)
#> Build the HMDP (4.1231e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5610de567520> of class 'HMDP' <0x5610dde55ad0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 9.323e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000178926 sec.)
#> Build the HMDP (4.5387e-05 sec.)
#> Checking MDP and found no errors (1.512e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5610de8ca730> of class 'HMDP' <0x5610dde55ad0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 8.953e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
