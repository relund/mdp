...
mdp<-loadMDP(prefix)
#> Read binary files (0.000132747 sec.)
#> Build the HMDP (3.1839e-05 sec.)
#> Checking MDP and found no errors (1.232e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bc72c5250> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.324e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000145342 sec.)
#> Build the HMDP (3.6408e-05 sec.)
#> Checking MDP and found no errors (1.323e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bbfd4aac0> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.163e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
