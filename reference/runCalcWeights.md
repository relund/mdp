...
- criterion:
  ...
  expected weights, if `min` use minimum-successor weights, if `max` use
  maximum-successor weights, if `secondMoment` use the second moment of
  total accumulated weight, and if `variance` use the
  law-of-total-variance recursion under the current policy.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000150456 sec.)
#> Build the HMDP (4.2184e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5615cea6a3b0> of class 'HMDP' <0x5615cc2e3490>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 1.0185e-05 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000183506 sec.)
#> Build the HMDP (4.2905e-05 sec.)
#> Checking MDP and found no errors (1.893e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5615d04e2080> of class 'HMDP' <0x5615cc2e3490>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
