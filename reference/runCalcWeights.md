...
mdp<-loadMDP(prefix)
#> Read binary files (0.000148506 sec.)
#> Build the HMDP (3.1298e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5571b1719590> of class 'HMDP' <0x5571adae1de0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.373e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000136053 sec.)
#> Build the HMDP (3.1068e-05 sec.)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.695e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
