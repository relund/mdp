...
mdp<-loadMDP(prefix)
#> Read binary files (0.000158765 sec.)
#> Build the HMDP (4.1481e-05 sec.)
#> Checking MDP and found no errors (1.052e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x56083a613ec0> of class 'HMDP' <0x56083a3616c0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 9.544e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000204021 sec.)
#> Build the HMDP (4.7109e-05 sec.)
#> Checking MDP and found no errors (2.043e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x56083964d4f0> of class 'HMDP' <0x56083a3616c0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 2.5447e-05 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
