...
mdp<-loadMDP(prefix)
#> Read binary files (0.000131465 sec.)
#> Build the HMDP (3.5637e-05 sec.)
#> Checking MDP and found no errors (9.92e-07 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55b912aa6000> of class 'HMDP' <0x55b90e7fa3b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.694e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000163085 sec.)
#> Build the HMDP (4.0826e-05 sec.)
#> Checking MDP and found no errors (1.533e-06 sec.)
mdp
#> $binNames
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.454e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
