...
mdp<-loadMDP(prefix)
#> Read binary files (0.000113049 sec.)
#> Build the HMDP (3.1527e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5603eadcd8d0> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.812e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000129404 sec.)
#> Build the HMDP (2.9414e-05 sec.)
#> Checking MDP and found no errors (1.272e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5603f3adf080> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using quantity 'Net reward' under reward criterion.
#>  Finished. Cpu time 7.921e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
