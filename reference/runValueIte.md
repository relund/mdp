...
mdp<-loadMDP(prefix)
#> Read binary files (0.000115533 sec.)
#> Build the HMDP (3.373e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5603f5c26f40> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.102e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000112749 sec.)
#> Build the HMDP (2.9794e-05 sec.)
#> Checking MDP and found no errors (1.202e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5603f6ffb490> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using quantity 'Net reward' under reward criterion.
#>  Finished. Cpu time 8.163e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
