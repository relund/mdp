...
mdp<-loadMDP(prefix)
#> Read binary files (0.00016648 sec.)
#> Build the HMDP (3.8578e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55df5da85220> of class 'HMDP' <0x55df5b4b0640>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 1.4652e-05 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000184007 sec.)
#> Build the HMDP (4.5559e-05 sec.)
#> Checking MDP and found no errors (2.995e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55df621ee5e0> of class 'HMDP' <0x55df5b4b0640>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
