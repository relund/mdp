...
mdp<-loadMDP(prefix)
#> Read binary files (0.000167408 sec.)
#> Build the HMDP (3.8587e-05 sec.)
#> Checking MDP and found no errors (1.032e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x560841f54300> of class 'HMDP' <0x56083a3616c0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.783e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000183 sec.)
#> Build the HMDP (4.06e-05 sec.)
#> Checking MDP and found no errors (2.564e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x56083f08e180> of class 'HMDP' <0x56083a3616c0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.644e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
