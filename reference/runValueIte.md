...
mdp<-loadMDP(prefix)
#> Read binary files (0.000127238 sec.)
#> Build the HMDP (3.1977e-05 sec.)
#> Checking MDP and found no errors (8.01e-07 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55ead33f81c0> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.253e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000146046 sec.)
#> Build the HMDP (3.5243e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55ead25b68c0> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 8.072e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
