...
mdp<-loadMDP(prefix)
#> Read binary files (0.000136033 sec.)
#> Build the HMDP (3.3192e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55cb9ea23960> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000141523 sec.)
#> Build the HMDP (5.7357e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55cb9dc0a680> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 6.503e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
