...
mdp<-loadMDP(prefix)
#> Read binary files (0.000154382 sec.)
#> Build the HMDP (3.6845e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5615ce959e30> of class 'HMDP' <0x5615cc2e3490>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 9.845e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000164638 sec.)
#> Build the HMDP (4.1062e-05 sec.)
#> Checking MDP and found no errors (1.752e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5615d164fa50> of class 'HMDP' <0x5615cc2e3490>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.474e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
