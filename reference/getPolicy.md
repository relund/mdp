...
mdp<-loadMDP(prefix)
#> Read binary files (0.000179336 sec.)
#> Build the HMDP (4.1652e-05 sec.)
#> Checking MDP and found no errors (1.422e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5610de58f360> of class 'HMDP' <0x5610dde55ad0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
mdp<-loadMDP(prefix)
#> Read binary files (0.00017521 sec.)
#> Build the HMDP (4.5488e-05 sec.)
#> Checking MDP and found no errors (1.653e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5610e217ed00> of class 'HMDP' <0x5610dde55ad0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.965e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
