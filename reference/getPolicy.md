...
mdp<-loadMDP(prefix)
#> Read binary files (0.000132356 sec.)
#> Build the HMDP (3.251e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5571b3621770> of class 'HMDP' <0x5571adae1de0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 6.051e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000139909 sec.)
#> Build the HMDP (3.3131e-05 sec.)
#> Checking MDP and found no errors (1.282e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5571ad13cb70> of class 'HMDP' <0x5571adae1de0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 5.31e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
