...
mdp<-loadMDP(prefix)
#> Read binary files (0.000128619 sec.)
#> Build the HMDP (3.6649e-05 sec.)
#> Checking MDP and found no errors (1.253e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55cb9c571950> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000138728 sec.)
#> Build the HMDP (5.36e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55cb9f338d80> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 1.2813e-05 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
