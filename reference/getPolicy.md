...
mdp<-loadMDP(prefix)
#> Read binary files (0.000162153 sec.)
#> Build the HMDP (3.8161e-05 sec.)
#> Checking MDP and found no errors (2.635e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55b90ed1ef60> of class 'HMDP' <0x55b90e7fa3b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.516e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000180858 sec.)
#> Build the HMDP (3.8462e-05 sec.)
#> Checking MDP and found no errors (3.306e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55b90ed6c6a0> of class 'HMDP' <0x55b90e7fa3b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
