...
mdp<-loadMDP(prefix)
#> Read binary files (0.000131756 sec.)
#> Build the HMDP (3.253e-05 sec.)
#> Checking MDP and found no errors (1.042e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bc54692b0> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.344e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.00016099 sec.)
#> Build the HMDP (3.3492e-05 sec.)
#> Checking MDP and found no errors (1.303e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bc82ef2d0> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.765e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
