...
mdp<-loadMDP(prefix)
#> Read binary files (0.000137794 sec.)
#> Build the HMDP (3.2939e-05 sec.)
#> Checking MDP and found no errors (8.31e-07 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55eacecaa200> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.322e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000136342 sec.)
#> Build the HMDP (3.407e-05 sec.)
#> Checking MDP and found no errors (1.332e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55eace847fd0> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.852e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
