...
mdp<-loadMDP(prefix)
#> Read binary files (0.000133167 sec.)
#> Build the HMDP (3.8001e-05 sec.)
#> Checking MDP and found no errors (1.453e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x559e28b07ad0> of class 'HMDP' <0x559e23190c70>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.975e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000134239 sec.)
#> Build the HMDP (3.5686e-05 sec.)
#> Checking MDP and found no errors (1.302e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x559e2ac834a0> of class 'HMDP' <0x559e23190c70>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.384e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
