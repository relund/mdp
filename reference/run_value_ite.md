...
mdp<-load_mdp(prefix)
#> Read binary files (0.000171622 sec.)
#> Build the HMDP (4.2362e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x556226da1c30> of class 'HMDP' <0x55622202d5e0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 9.915e-06 sec.
...
mdp<-load_mdp(prefix)
#> Read binary files (0.000168156 sec.)
#> Build the HMDP (3.9839e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x556227172380> of class 'HMDP' <0x55622202d5e0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.654e-06 sec.
get_policy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>     s_id state_str state_label a_idx action_label weight
#>    <dbl> <chr>     <chr>       <int> <chr>         <dbl>
