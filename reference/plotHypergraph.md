...
#> Read binary files (0.000105246 sec.)
#> Build the HMDP (3.1006e-05 sec.)
...
#>  Finished. Cpu time 9.424e-06 sec.
...
#> Read binary files (0.000112506 sec.)
#> Build the HMDP (2.6669e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 9.92e-07 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000228919 sec.)
#> Build the HMDP (0.000119316 sec.)
#> Checking MDP and found no errors (2.053e-06 sec.)
