...
#> Read binary files (0.000138057 sec.)
#> Build the HMDP (3.986e-05 sec.)
...
#>  Finished. Cpu time 1.0085e-05 sec.
...
#> Read binary files (0.00012639 sec.)
#> Build the HMDP (3.0746e-05 sec.)
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000243325 sec.)
#> Build the HMDP (0.000144147 sec.)
#> Checking MDP and found no errors (2.584e-06 sec.)
