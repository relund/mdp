...
#> Read binary files (0.000133501 sec.)
#> Build the HMDP (4.017e-05 sec.)
...
#>  Finished. Cpu time 9.875e-06 sec.
...
#> Read binary files (0.00012604 sec.)
#> Build the HMDP (3.0205e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.352e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000256075 sec.)
#> Build the HMDP (0.000185299 sec.)
#> Checking MDP and found no errors (3.125e-06 sec.)
