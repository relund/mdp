...
#> Read binary files (0.000140022 sec.)
#> Build the HMDP (3.6007e-05 sec.)
...
#>  Finished. Cpu time 7.413e-06 sec.
...
#> Read binary files (0.000108091 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.032e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000221794 sec.)
#> Build the HMDP (0.000145762 sec.)
#> Checking MDP and found no errors (2.745e-06 sec.)
