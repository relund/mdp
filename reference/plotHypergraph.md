...
#> Read binary files (0.000140489 sec.)
#> Build the HMDP (4.0671e-05 sec.)
...
#>  Finished. Cpu time 9.994e-06 sec.
...
#> Read binary files (0.000134549 sec.)
#> Build the HMDP (3.1927e-05 sec.)
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000239546 sec.)
#> Build the HMDP (0.00018176 sec.)
#> Checking MDP and found no errors (2.554e-06 sec.)
