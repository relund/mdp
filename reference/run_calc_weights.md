...
mdp<-load_mdp(prefix)
#> Read binary files (0.000125511 sec.)
#> Build the HMDP (3.4272e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x564393e4abb0> of class 'HMDP' <0x5643940938b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.662e-06 sec.
...
mdp<-load_mdp(prefix)
#> Read binary files (0.000132421 sec.)
#> Build the HMDP (5.7888e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x564399ee4790> of class 'HMDP' <0x5643940938b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
