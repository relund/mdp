...
#> Read binary files (0.000139434 sec.)
#> Build the HMDP (5.9167e-05 sec.)
#> Checking MDP and found no errors (1.211e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 9.524e-06 sec.
...
#> Read binary files (0.0001297 sec.)
#> Build the HMDP (3.1056e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.382e-06 sec.
#> [1] -0.43379
plot(mdp, action_color = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-load_mdp("cow_")
#> Read binary files (0.000257858 sec.)
#> Build the HMDP (0.000193004 sec.)
#> Checking MDP and found no errors (2.994e-06 sec.)
