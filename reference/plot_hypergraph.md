...
#> Read binary files (0.00016249 sec.)
#> Build the HMDP (4.9412e-05 sec.)
...
#>  Finished. Cpu time 9.754e-06 sec.
...
#> Read binary files (0.000134228 sec.)
#> Build the HMDP (3.2398e-05 sec.)
#> Checking MDP and found no errors (1.732e-06 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.732e-06 sec.
#> [1] -0.43379
plot(mdp, action_color = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-load_mdp("cow_")
#> Read binary files (0.000316397 sec.)
#> Build the HMDP (0.000217131 sec.)
#> Checking MDP and found no errors (3.646e-06 sec.)
