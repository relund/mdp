...
mdp<-loadMDP(prefix)
#> Read binary files (0.000138338 sec.)
#> Build the HMDP (3.4795e-05 sec.)
#> Checking MDP and found no errors (1.213e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bc4490930> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.115e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000139841 sec.)
#> Build the HMDP (3.5647e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x557bc38157f0> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.664e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
