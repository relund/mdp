...
mdp<-loadMDP(prefix)
#> Read binary files (0.000163466 sec.)
#> Build the HMDP (3.972e-05 sec.)
#> Checking MDP and found no errors (1.012e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55df5cebadd0> of class 'HMDP' <0x55df5b4b0640>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 9.925e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000203896 sec.)
#> Build the HMDP (5.5263e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55df5df28c10> of class 'HMDP' <0x55df5b4b0640>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.224e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
