...
mdp<-loadMDP(prefix)
#> Read binary files (0.000125125 sec.)
#> Build the HMDP (3.4611e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55eaced8f1a0> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.283e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000139116 sec.)
#> Build the HMDP (3.6374e-05 sec.)
#> Checking MDP and found no errors (1.443e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55eacf301110> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.962e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
