...
mdp<-loadMDP(prefix)
#> Read binary files (9.3164e-05 sec.)
#> Build the HMDP (3.2992e-05 sec.)
#> Checking MDP and found no errors (1.63e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55a88bc88410> of class 'HMDP' <0x55a887db2f30>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.467e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000128474 sec.)
#> Build the HMDP (3.3656e-05 sec.)
#> Checking MDP and found no errors (2.896e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55a88d273ee0> of class 'HMDP' <0x55a887db2f30>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using quantity 'Net reward' under reward criterion.
#>  Finished. Cpu time 7.72e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
