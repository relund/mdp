...
mdp<-loadMDP(prefix)
#> Read binary files (9.9229e-05 sec.)
#> Build the HMDP (3.1147e-05 sec.)
#> Checking MDP and found no errors (6.91e-07 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5603f3957500> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.182e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000118007 sec.)
#> Build the HMDP (3.2248e-05 sec.)
#> Checking MDP and found no errors (8.41e-07 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5603f1c791a0> of class 'HMDP' <0x5603f05275f0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
