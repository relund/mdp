...
mdp<-loadMDP(prefix)
#> Read binary files (0.000147605 sec.)
#> Build the HMDP (3.9594e-05 sec.)
#> Checking MDP and found no errors (3.045e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55b90e869980> of class 'HMDP' <0x55b90e7fa3b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.934e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000184915 sec.)
#> Build the HMDP (3.9313e-05 sec.)
#> Checking MDP and found no errors (2.946e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x55b90fdddf40> of class 'HMDP' <0x55b90e7fa3b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.117e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
