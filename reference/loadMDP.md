...
mdp<-loadMDP(prefix)
#> Read binary files (0.000156771 sec.)
#> Build the HMDP (3.1648e-05 sec.)
#> Checking MDP and found no errors (1.333e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5571b03ef300> of class 'HMDP' <0x5571adae1de0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 5.58e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000137836 sec.)
#> Build the HMDP (3.4313e-05 sec.)
#> Checking MDP and found no errors (2.334e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x5571ae278ba0> of class 'HMDP' <0x5571adae1de0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 5.51e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
