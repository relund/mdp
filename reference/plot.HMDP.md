...
#> Read binary files (0.000137142 sec.)
#> Build the HMDP (6.1701e-05 sec.)
...
#>  Finished. Cpu time 9.314e-06 sec.
...
#> Read binary files (0.000130302 sec.)
#> Build the HMDP (4.9513e-05 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.913e-06 sec.
#> [1] -0.43379
plot(mdp, action_color = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-load_mdp("cow_")
#> Read binary files (0.000253163 sec.)
#> Build the HMDP (0.000179635 sec.)
#> Checking MDP and found no errors (3.876e-06 sec.)
