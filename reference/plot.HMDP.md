...
#> Read binary files (0.000147439 sec.)
#> Build the HMDP (4.7681e-05 sec.)
#> Checking MDP and found no errors (1.522e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 1.0045e-05 sec.
...
#> Read binary files (0.000156512 sec.)
#> Build the HMDP (3.6264e-05 sec.)
#> Checking MDP and found no errors (1.802e-06 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.802e-06 sec.
#> [1] -0.43379
plot(mdp, actionColor = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000289841 sec.)
#> Build the HMDP (0.000186246 sec.)
#> Checking MDP and found no errors (2.774e-06 sec.)
