...
#> Read binary files (0.000105956 sec.)
#> Build the HMDP (3.2529e-05 sec.)
#> Checking MDP and found no errors (9.51e-07 sec.)
plot(mdp)
...
#>  Finished. Cpu time 1.9098e-05 sec.
...
#> Read binary files (0.000112146 sec.)
#> Build the HMDP (2.5899e-05 sec.)
...
library(magrittr)
mdp<-loadMDP("cow_")
#> Read binary files (0.000204563 sec.)
#> Build the HMDP (0.000127408 sec.)
#> Checking MDP and found no errors (4.447e-06 sec.)
