...
mdp<-load_mdp(prefix)
#> Read binary files (0.000168529 sec.)
#> Build the HMDP (4.3243e-05 sec.)
...
#>  Finished. Cpu time 9.434e-06 sec.
...
mdp<-load_mdp(prefix)
#> Read binary files (0.000196721 sec.)
#> Build the HMDP (4.1621e-05 sec.)
#> Checking MDP and found no errors (1.863e-06 sec.)
mdp
#> $bin_names
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 9.864e-06 sec.
get_policy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>     s_id state_str state_label a_idx action_label weight
#>    <dbl> <chr>     <chr>       <int> <chr>         <dbl>
