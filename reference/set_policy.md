...
mdp<-load_mdp(prefix)
#> Read binary files (0.000160873 sec.)
#> Build the HMDP (4.2194e-05 sec.)
#> Checking MDP and found no errors (1.662e-06 sec.)
mdp
#> $bin_names
...
#> 
#> $ptr
#> C++ object <0x5624be08ee60> of class 'HMDP' <0x5624bad18460>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.984e-06 sec.
...
mdp<-load_mdp(prefix)
#> Read binary files (0.000169116 sec.)
#> Build the HMDP (4.3275e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x5624be913df0> of class 'HMDP' <0x5624bad18460>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 8.563e-06 sec.
get_policy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>     s_id state_str state_label a_idx action_label weight
#>    <dbl> <chr>     <chr>       <int> <chr>         <dbl>
