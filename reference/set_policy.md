...
mdp<-load_mdp(prefix)
#> Read binary files (0.000121835 sec.)
#> Build the HMDP (3.0827e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x56439743cc20> of class 'HMDP' <0x5643940938b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 8.132e-06 sec.
...
mdp<-load_mdp(prefix)
#> Read binary files (0.000137498 sec.)
#> Build the HMDP (3.8078e-05 sec.)
#> Checking MDP and found no errors (9.11e-07 sec.)
mdp
#> $bin_names
...
#> 
#> $ptr
#> C++ object <0x56439670b9e0> of class 'HMDP' <0x5643940938b0>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.391e-06 sec.
get_policy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>     s_id state_str state_label a_idx action_label weight
#>    <dbl> <chr>     <chr>       <int> <chr>         <dbl>
