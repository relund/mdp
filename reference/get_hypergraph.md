...
#> Read binary files (0.000166712 sec.)
#> Build the HMDP (2.9554e-05 sec.)
#> Checking MDP and found no errors (4.297e-06 sec.)
plot(mdp)
...
#>  Finished. Cpu time 6.59e-06 sec.
...
#> Read binary files (0.000136756 sec.)
#> Build the HMDP (2.2694e-05 sec.)
#> Checking MDP and found no errors (1.131e-06 sec.)
...
#> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 1.131e-06 sec.
#> [1] -0.43379
plot(mdp, action_color = "policy")  # highlight optimal policy
...
library(magrittr)
mdp<-load_mdp("cow_")
#> Read binary files (0.000202185 sec.)
#> Build the HMDP (0.000135494 sec.)
