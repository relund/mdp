...
mdp<-loadMDP(prefix)
#> Read binary files (0.000129031 sec.)
#> Build the HMDP (3.3042e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x557bc6e0fa70> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.725e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.00013962 sec.)
#> Build the HMDP (3.3332e-05 sec.)
#> Checking MDP and found no errors (1.263e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x557bc4491180> of class 'HMDP' <0x557bc3143d40>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
