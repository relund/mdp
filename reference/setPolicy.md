...
mdp<-loadMDP(prefix)
#> Read binary files (0.000133278 sec.)
#> Build the HMDP (3.6528e-05 sec.)
#> Checking MDP and found no errors (1.133e-06 sec.)
mdp
#> $binNames
...
#> 
#> $ptr
#> C++ object <0x559e28a66770> of class 'HMDP' <0x559e23190c70>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#>  Finished. Cpu time 7.164e-06 sec.
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000156491 sec.)
#> Build the HMDP (3.4163e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x559e2589eb90> of class 'HMDP' <0x559e23190c70>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.504e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
