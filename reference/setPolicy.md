...
mdp<-loadMDP(prefix)
#> Read binary files (0.000135011 sec.)
#> Build the HMDP (4.2679e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55cba0e70fb0> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
mdp<-loadMDP(prefix)
#> Read binary files (0.00013956 sec.)
#> Build the HMDP (3.6658e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55cb9e558280> of class 'HMDP' <0x55cb9c510630>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.404e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
