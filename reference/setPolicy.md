...
mdp<-loadMDP(prefix)
#> Read binary files (0.00013499 sec.)
#> Build the HMDP (3.4071e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55ead3049550> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
mdp<-loadMDP(prefix)
#> Read binary files (0.000145495 sec.)
#> Build the HMDP (3.4351e-05 sec.)
...
#> 
#> $ptr
#> C++ object <0x55ead4e00a70> of class 'HMDP' <0x55eace834030>
#> 
#> attr(,"class")
#> [1] "HMDP" "list"
plot(mdp)
...
#> Run value iteration with epsilon = 0 at most 1 time(s)
#> using weight 'Net reward' under expected-weight Bellman operator.
#>  Finished. Cpu time 7.931e-06 sec.
getPolicy(mdp)     # optimal policy
#> # A tibble: 13 × 6
#>      sId stateStr stateLabel   aIdx actionLabel weight
#>    <dbl> <chr>    <chr>       <int> <chr>        <dbl>
