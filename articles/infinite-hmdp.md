...
```
    ...
    #> Read binary files (0.000313733 sec.)
    #> Build the HMDP (0.000186195 sec.)

    #> Checking MDP and found no errors (4.917e-06 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x564ab8913680> of class 'HMDP' <0x564abb4a0480>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> Iteration(s): 1 2 3 4 finished. Cpu time: 4.917e-06 sec.
...
```
    ...
    #> 1 (11000) 2 (11517.5) 3 (11543.8) 4 (11543.8) finished. Cpu time: 4.917e-06 sec.
