...
```
    ...
    #> Read binary files (0.00025757 sec.)
    #> Build the HMDP (0.000136153 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x5605f8fb0d60> of class 'HMDP' <0x5605f67b5990>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> Iteration(s): 1 2 3 4 finished. Cpu time: 1.873e-06 sec.
...
```
    ...
    #> 1 (11000) 2 (11517.5) 3 (11543.8) 4 (11543.8) finished. Cpu time: 1.873e-06 sec.
