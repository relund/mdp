...
```
    ...
    #> Read binary files (0.000246168 sec.)
    #> Build the HMDP (0.000187238 sec.)

    #> Checking MDP and found no errors (3.937e-06 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x5621a6d86460> of class 'HMDP' <0x5621a358dcf0>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> Iteration(s): 1 2 3 4 finished. Cpu time: 3.937e-06 sec.
...
```
    ...
    #> 1 (11000) 2 (11517.5) 3 (11543.8) 4 (11543.8) finished. Cpu time: 3.937e-06 sec.
