...
```
    ...
    #> Read binary files (0.000162145 sec.)
    #> Build the HMDP (2.7582e-05 sec.)

    #> Checking MDP and found no errors (4.046e-06 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x5626517814d0> of class 'HMDP' <0x562651d36c30>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 4.046e-06 sec.
...
```
    ...
    #> Iteration(s): 1 2 finished. Cpu time: 4.046e-06 sec.
...
```
    ...
    #> with 'Duration' as duration using discount factor 0.5.
    #> Iterations: 33 Finished. Cpu time 1.992e-05 sec.
