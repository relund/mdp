...
```
    ...
    #> Read binary files (0.000174452 sec.)
    #> Build the HMDP (2.9093e-05 sec.)

    #> Checking MDP and found no errors (9.72e-07 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x55cd04b6f810> of class 'HMDP' <0x55cd021fe530>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 9.72e-07 sec.
...
```
    ...
    #> Iteration(s): 1 2 finished. Cpu time: 9.72e-07 sec.
...
```
    ...
    #> with 'Duration' as duration using discount factor 0.5.
    #> Iterations: 33 Finished. Cpu time 2.2093e-05 sec.
