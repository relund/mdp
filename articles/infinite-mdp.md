...
```
    ...
    #> Read binary files (0.000138789 sec.)
    #> Build the HMDP (2.4094e-05 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x5570598967a0> of class 'HMDP' <0x557056dd4530>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 9.11e-07 sec.
...
```
    ...
    #> Iteration(s): 1 2 finished. Cpu time: 9.11e-07 sec.
...
```
    ...
    #> with 'Duration' as duration using discount factor 0.5.
    #> Iterations: 33 Finished. Cpu time 2.0368e-05 sec.
