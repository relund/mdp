...
```
    ...
    #> Read binary files (0.000140081 sec.)
    #> Build the HMDP (2.9905e-05 sec.)

    #> Checking MDP and found no errors (3.927e-06 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x561ac4fe7190> of class 'HMDP' <0x561ac559c6b0>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> 1 (-0.512821) 2 (-0.446154) 3 (-0.43379) 4 (-0.43379) finished. Cpu time: 3.927e-06 sec.
...
```
    ...
    #> Iteration(s): 1 2 finished. Cpu time: 3.927e-06 sec.
...
```
    ...
    #> with 'Duration' as duration using discount factor 0.5.
    #> Iterations: 33 Finished. Cpu time 1.9908e-05 sec.
