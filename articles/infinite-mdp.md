...
```
    ...
    #> Read binary files (0.00016866 sec.)
    #> Build the HMDP (2.727e-05 sec.)
...
```
    ...
    #> 
    #> $ptr
    #> C++ object <0x563f0536d7a0> of class 'HMDP' <0x563f028ab530>
    #> 
    #> attr(,"class")
    #> [1] "HMDP" "list"
...
```
    ...
    #> Iteration(s): 1 2 finished. Cpu time: 1.002e-06 sec.
...
```
    ...
    #> with 'Duration' as duration using discount factor 0.5.
    #> Iterations: 33 Finished. Cpu time 1.9999e-05 sec.
