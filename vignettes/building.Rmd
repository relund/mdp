...
options(rmarkdown.html_vignette.check_title = FALSE,
        ...
        # digits=5,
        width=90) # 
par(oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0)) # bottom, left, top, and right
...
```{r semi-mdp, echo=FALSE, results='hide', message=FALSE, fig.cap="Figure 1: The state-expanded hypergraph for the semi-MDP."}
...
```{r plotHgf3, echo=FALSE, fig.cap="Figure 2: A finite-horizon MDP"}
par(oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0))
...
```{r plotHMDP, echo=FALSE, message=FALSE}
mdp<-loadMDP(prefix)
